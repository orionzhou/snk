rule star:
    input:
        fq1 = "14.trim/{sid}_1.PE.fq.gz",
        fq2 = "14.trim/{sid}_2.PE.fq.gz",
...
rule sambamba_merge:
    ...
    params:
        config["sambamba_merge"]["extra"]
    threads:
        config["sambamba_merge"]["threads"]
    run:
        shell("sambamba merge -t {threads} {params} {output} {input}")
